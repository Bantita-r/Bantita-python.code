...
#FileNotFoundException, PermissionException สามารถทำงานรวมกับไฟล์อื่นได้เพื่อเข้าไปอ่านData
try:
...
#raise ใช้สำหรับ สั่งให้ Python สร้าง Exception ขึ้นเอง เมื่อข้อมูลหรือสถานการณ์ไม่เป็นไปตามแม้คำสั่งนั้นจะไม่ผิดไวยากรณ์และ Python ยังทำงานต่อไปได้ตามปกติก็ตาม
